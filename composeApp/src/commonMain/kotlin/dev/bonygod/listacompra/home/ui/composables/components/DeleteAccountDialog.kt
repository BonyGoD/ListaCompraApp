...
fun DeleteAccountDialog(
    ...
    Dialog(
        onDismissRequest = { setEvent(ListaCompraEvent.DismissDeleteAccountDialog) },
        ...
        Card(
            ...
            Column(
                ...
                Button(
                    onClick = {
                        setEvent(ListaCompraEvent.OnDeleteAccountConfirm)
                    },
                    modifier = Modifier.padding(bottom = 20.dp, top = 20.dp),
                    colors = ButtonDefaults.buttonColors(containerColor = PrimaryBlue)
                ) {
                    Text(text = stringResource(Res.string.delete_account_button))
                }
            }
        }
    }
